...
public class HDFSTest {
	...
	/* 获取文件信息 */
	public void getFileInfo(String filePath) throws URISyntaxException, IOException {
		getFileSystem();
	...
	/* 创建目录 */
	public void createDir(String dirName) throws URISyntaxException, IOException {
		getFileSystem();
	...
	/* 写入文件 */
	public void createFile(String filePath, String content) throws URISyntaxException, IOException {
		getFileSystem();
		Path path = new Path(filePath);
	...
	/* 上传文件 */
	public void uploadFile(String srcPath, String dstPath) throws URISyntaxException, IOException {
		getFileSystem();
	...
	/* 使用文件流上传文件 */
	public void uploadFileByStream(String srcPath, String dstPath) throws IOException, URISyntaxException {
		getFileSystem();
	...
	/* 删除文件、目录 */
	public void deleteFileAndDir(String filePath) throws URISyntaxException, IOException {
		getFileSystem();
	...
	/* 压缩文件 */
	public void gzipCompressFile(String filePath, String compressPath)
